"""FastAPI sub-app for the bridge variant.

Mounted at /bridge by src/main.py. Routes are relative to that mount, so
internally this app uses /, /ws, /static/*. From the outside they show
up as /bridge/, /bridge/ws, /bridge/static/*.
"""
...
from src.bridge.rooms import MAX_PLAYERS, Phase, Player, Table, table

log = logging.getLogger("bridge")

app = FastAPI(title="bridge — games.djiang.xyz", docs_url=None, redoc_url=None)
